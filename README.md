...
```bash
podman pull ghcr.io/uglykitty/ws2tcp-router:0.2.2
podman run --rm -p 8000:8000 ghcr.io/uglykitty/ws2tcp-router:0.2.2
```
...
```text
ok: ws2tcp-router 0.2.2 is available; health check only, no upstream connected
```
